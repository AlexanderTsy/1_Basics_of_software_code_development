...
public class Task4 {
	 ...
	 * 				Кирпич пройдет через отверстие, если один из размеров отверстия
	 * 				будет больше либо равен по крайней мере двум размерам кирпича,
	 * 				а другой из размеров отверстия будет больше либо равен по крайней
	 * 				мере одному размеру кирпича
	 */
