...
public class Task1 {
	...
	// Предположим что пользователь вводит через пробел значения двух углов, используем тип float для этих значений  
	public static void main(String[] args) {
		...
		try {
			...
			// Сумма углов треугольника равна 180 градусов. Следовательно сумма двух углов не превышает 180. 
